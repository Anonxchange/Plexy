...
export function ShopPost() {
  useHead({ title: "Sell on Pexly | Create a Listing", meta: [{ name: "description", content: "List a product or service in the Pexly shop and accept cryptocurrency payments." }] });
