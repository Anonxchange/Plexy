...
export function PexlyAcademy() {
  useHead({ title: "Pexly Academy | Learn Crypto & DeFi", meta: [{ name: "description", content: "Guides, tutorials, and courses on cryptocurrency and decentralized finance for all levels." }] });
