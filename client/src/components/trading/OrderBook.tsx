...
const generateOrders = (basePrice: number, side: "ask" | "bid", count: number) => {
  ...
  const sizes = side === "ask" 
    ? [93.04, 634.41, 1140, 1430, 2020, 2560, 3260, 3560]
    : [19.94, 564.67, 1260, 1270, 1720, 2300, 5170];
...
const asks = generateOrders(basePrice, "ask", 7);
const bids = generateOrders(basePrice, "bid", 7);
