...
const DesktopTradingLayout = ({
  ...
  return (
    <div className="grid grid-cols-[1.7fr_0.6fr_0.6fr] grid-rows-[auto_minmax(300px,1fr)_auto_auto] flex-1 min-h-0 overflow-hidden border-t-2 border-border">
      ...
      {/* Full-width horizontal line under Tabs Header */}
      ...
      <div className="col-start-3 row-start-1 row-end-4 overflow-y-auto min-h-0">
        <TradePanel />
      </div>

      {/* Account Panel — spans rows 3-4, vertical line only here */}
