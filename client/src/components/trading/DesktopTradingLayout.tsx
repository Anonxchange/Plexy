...
return ( <div className="grid grid-cols-[1.7fr_0.6fr_0.6fr] grid-rows-[auto_minmax(300px,1fr)_auto_auto] flex-1 min-h-0 overflow-hidden border-t-2 border-border">
