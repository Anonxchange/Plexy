...
const footerSections = [
  ...
  {
    title: "Useful Links",
    links: [{ text: "Support", href: "https://help.pexly.app" }, { text: "Bitcoin Calculator", href: "/bitcoin-calculator" }, { text: "Pexly Academy", href: "/academy" }, { text: "Market Prices", href: "/markets" }, { text: "Blog", href: "/blog" }]
  },
  {
    title: "About Pexly",
...
export function PexlyFooter() {
  ...
  return (
    <footer className="bg-[#fcfcfc] dark:bg-background border-t text-foreground">
