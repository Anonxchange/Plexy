...
export function PexlyFooter() {
  ...
  return (
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 py-8 lg:px-6 lg:py-12 max-w-7xl">
        {/* Logo */}
        ...
        <div className="hidden lg:grid lg:grid-cols-4 xl:grid-cols-7 gap-6 lg:gap-8 mb-8 lg:mb-12">
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-sm lg:text-base font-semibold mb-3 lg:mb-4">{section.title}</h3>
              <ul className="space-y-2 lg:space-y-3 text-xs text-muted-foreground">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-3 lg:mb-6 flex-wrap">
          <Select defaultValue="en">
        ...
        <div className="flex gap-3 pt-6 lg:pt-0 flex-wrap">
          <a
            href="#"
            className="flex-1 lg:flex-none min-w-[140px] lg:min-w-[150px]"
          >
            <div className="bg-black text-white rounded-lg px-3 py-2.5 flex items-center justify-center gap-2 hover:bg-black/90 transition-colors">
              ...
              <div className="text-left">
                <div className="text-[10px]">Get it on the</div>
        ...
        {/* Social Media Icons */}
        <div className="flex justify-center lg:justify-start gap-3 pt-4 lg:pt-6 flex-wrap">
          <a href="#" className="w-10 h-10 border rounded-lg flex items-center justify-center hover:bg-accent transition-colors flex-shrink-0">
        ...
        {/* Legal Disclaimer */}
        <div className="text-[10px] text-muted-foreground leading-relaxed pt-4 lg:pt-6 border-t mt-6 lg:mt-8">
          <p>
