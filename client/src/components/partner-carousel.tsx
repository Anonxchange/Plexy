const partners = [
  { name: "AsterDEX", logo: "/logos/asterdex-logo.png", invert: false },
  { name: "RocketX", logo: "/logos/rocketx-logo.png", invert: false },
  { name: "Coinbase", logo: "/logos/coinbase-logo.svg", invert: true },
  { name: "Reloadly", logo: "/logos/reloadly-logo.png", invert: false },
  { name: "Polymarket", logo: "/logos/polymarket-logo.png", invert: false },
