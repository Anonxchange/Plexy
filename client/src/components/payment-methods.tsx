...
const paymentCategories = [
  ...
  { icon: "bitcoin", color: "#F59E0B", name: "Buy crypto", count: "150+", description: "Receive your stablecoins directly in your Pexly wallet", route: "/buy-crypto" },
  ...
  { icon: "giftcard", color: "#06B6D4", name: "Pexly gift card", count: "85+", description: "Gift crypto instantly with a simple, secure Pexly link", route: "/pexly-pay" },
