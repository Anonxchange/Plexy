...
const paymentCategories = [
  { image: "/assets/IMG_1803.jpeg", name: "Bank Transfer", count: "200+", methods: ["ACH", "SEPA", "Wire Transfer", "SWIFT", "Local Bank", "BACS", "CHAPS", "FPS", "TARGET2", "RTGS"] },
  ...
  { image: "/assets/IMG_1809.jpeg", name: "Digital Wallets", count: "90+", methods: ["Zelle", "Venmo", "Cash App", "Apple Pay", "Google Pay", "Samsung Pay", "WeChat Pay", "Alipay", "PhonePe", "Paytm"] },
  { image: "/assets/IMG_1810.jpeg", name: "Cash Payments", count: "60+", methods: ["Cash Deposit", "Cash in Person", "ATM", "Western Union", "Remitly", "Ria", "Moneygram", "Xoom", "WorldRemit", "Cash Pickup"] },
  ...
  { image: "/assets/IMG_1824.jpeg", name: "Crypto Payments", count: "40+", methods: ["Bitcoin", "Ethereum", "USDT", "USDC", "BNB", "XRP", "Litecoin", "Dogecoin", "Cardano", "Solana"] },
  { image: "/assets/IMG_1827.jpeg", name: "Point of Sale", count: "35+", methods: ["Square", "Stripe", "PayPal Here", "SumUp", "iZettle", "Clover", "Toast", "Shopify POS", "Lightspeed", "Vend"] },
