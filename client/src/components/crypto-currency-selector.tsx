...
import { Check, ChevronsUpDown, ChevronDown } from '@/lib/icons';
...
const cryptoCurrencies: CryptoCurrency[] = [
  ...
  { symbol: "XRP", name: "XRP", iconUrl: cryptoIconUrls.XRP },
  { symbol: "BNB", name: "Binance Coin", iconUrl: cryptoIconUrls.BNB },
  { symbol: "MATIC", name: "Polygon", iconUrl: cryptoIconUrls.MATIC },
  { symbol: "ARB", name: "Arbitrum", iconUrl: cryptoIconUrls.ARB },
  { symbol: "OP", name: "Optimism", iconUrl: cryptoIconUrls.OP },
  { symbol: "AVAX", name: "Avalanche", iconUrl: cryptoIconUrls.AVAX },
