...
export function P2P() {
  ...
  const cryptocurrencies = [
    ...
    { 
      symbol: "LTC", 
      name: "Litecoin", 
      iconUrl: cryptoIconUrls.LTC, 
      price: cryptoPrices['LTC']?.current_price || 0 
    },
  ];
      ...
      <main className="flex-1">
        ...
        <div className="lg:hidden px-4 py-6">
          ...
          <P2PFiltersDialog
            ...
            setShowTopRatedOnly={setShowTopRatedOnly}
            verifiedUsersOnly={verifiedUsersOnly}
            setVerifiedUsersOnly={setVerifiedUsersOnly}
            recentlyActive={recentlyActive}
            setRecentlyActive={setRecentlyActive}
            acceptableOnly={acceptableOnly}
            setAcceptableOnly={setAcceptableOnly}
