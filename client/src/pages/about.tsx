...
export default function About() {
  useHead({ title: "About Pexly | Our Mission & Team", meta: [{ name: "description", content: "Learn about Pexly and our mission to build non-custodial decentralized financial tools." }] });
  return (
