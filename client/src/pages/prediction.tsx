...
export default function PredictionPage() {
  ...
  const categories = ["All", ...new Set(markets?.flatMap(m => m.tags || []) || [])].filter(Boolean);
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto py-4 px-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-4 overflow-x-auto pb-2 md:pb-0 no-scrollbar">
            <h1 className="text-xl font-bold tracking-tight shrink-0">Markets</h1>
      ...
      <div className="container mx-auto py-8 px-4">
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {displayedMarkets?.map((market: PolymarketMarket) => {
