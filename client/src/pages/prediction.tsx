...
export default function PredictionPage() {
  useHead({ title: "Crypto Predictions | Pexly", meta: [{ name: "description", content: "Forecast cryptocurrency price movements and compete with the community to track your prediction accuracy." }] });
