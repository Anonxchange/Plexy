...
const Careers = () => {
  useHead({ title: "Careers | Join Pexly", meta: [{ name: "description", content: "Open roles at Pexly — join the team building next-generation decentralized financial tools." }] });
  return (
