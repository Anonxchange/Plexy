...
import iconTime from "@/assets/svg-image-1 20.svg";
...
const testimonials = [
  {
    name: "Sarah Chen",
    handle: "@sarahchen",
    quote: "Joining Pexly was the best career decision I've made. The remote-first culture and supportive team have helped me grow both professionally and personally.",
    avatar: "SC"
  },
  {
    name: "Marcus Johnson",
  ...
  },
  {
    ...
    handle: "@elenar",
    quote: "What sets Pexly apart is the genuine care for employee well-being. The flexible hours let me be present for my family while doing meaningful work.",
    avatar: "ER"
  },
  {
    name: "David Park",
    handle: "@davidp",
    quote: "I love the technical challenges we solve every day. Building a global p2p platform requires innovative thinking and a great team.",
    avatar: "DP"
  }
];
...
const Careers = () => {
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-primary selection:text-primary-foreground">
      {/* Hero Section */}
      <section className="relative flex flex-col md:flex-row items-center justify-between px-6 md:px-20 pt-32 pb-20 max-w-7xl mx-auto">
        <div className="md:w-1/2 text-left z-10">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-xl mb-10 leading-relaxed">
            At Pexly, we're building the future of peer-to-peer finance. Join a passionate team of innovators, creators, and problem-solvers who are redefining how the world trades.
          </p>
        ...
        <div className="md:w-1/2 mt-12 md:mt-0 flex justify-end">
          <img src={heroIllustration} alt="Hero illustration" className="w-full max-w-xl h-auto" />
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-24 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              We invest in our people. At Pexly, you'll find benefits designed to support your life, not just your work, helping you perform at your best.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {perks.map((perk, index) => (
            <div key={index} className="bg-card border border-border rounded-[32px] p-10 flex flex-col items-center text-center group hover:border-primary/50 transition-colors">
        ...
        <div className="flex flex-col md:flex-row gap-20">
          <div className="md:w-1/3">
            ...
            <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
              Don't just take our word for it. Here's what our team members have to say about the culture and opportunities at Pexly.
            </p>
          ...
          <div className="md:w-2/3 grid md:grid-cols-2 gap-6">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-card border border-border rounded-[32px] p-8 hover:border-primary/50 transition-colors">
      ...
      <section className="px-6 md:px-20 py-24 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-20">
          <div className="md:w-1/3">
            ...
            <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
              Ready to make an impact? Explore our current openings and find your next challenge in the world of crypto and fintech.
            </p>
            <Button className="rounded-full px-10 py-6 text-lg font-semibold">
              Contact us
            </Button>
            ...
            <div className="bg-card border border-border rounded-[40px] overflow-hidden">
              <div className="divide-y divide-border">
                {positions.map((position, index) => (
                  <a key={index} href="#" className="flex items-center justify-between p-10 group hover:bg-muted/50 transition-all">
                    <div>
