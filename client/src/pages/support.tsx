...
const HelpCenter = () => {
  useHead({ title: "Help Center | Pexly", meta: [{ name: "description", content: "Browse support articles or contact our team for help with your account and platform features." }] });
