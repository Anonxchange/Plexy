...
export default function CookiePolicy() {
  useHead({ title: "Cookie Policy | Pexly", meta: [{ name: "description", content: "How Pexly uses cookies and similar technologies across our platform." }] });
  ...
  return (
    <div className="min-h-screen bg-background">
      <LegalPageHero
        title="Cookie Policy"
        subtitle="Learn about how we use cookies and similar technologies on our platform"
