...
export default function Analysis() {
  useHead({ title: "Market Analysis | Pexly", meta: [{ name: "description", content: "Advanced on-chain and market analysis tools. Explore price trends and data-driven insights across major crypto assets." }] });
