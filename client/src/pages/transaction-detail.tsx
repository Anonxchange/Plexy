...
import { Copy, Search, Menu, X, Github, Twitter, CheckCircle2, Download } from "lucide-react";
          ...
          <CardContent className="pt-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <code className="text-sm break-all text-cyan-500 mb-4 block font-mono">{txHash}</code>
          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{txData.time ? formatTimestamp(txData.time) : 'Pending'}</p>
              </div>
